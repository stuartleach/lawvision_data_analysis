...
COLUMNS_OF_INTEREST = [
    ...
    "rearrest_firearm",
    "rearrest_date_firearm", "race", "average_bail_amount_cases", "number_of_cases_cases",
    "average_known_days_in_custody", "remanded_percentage", "bail_set_percentage", "disposed_at_arraign_percentage",
    "ror_percentage", "nonmonetary_release_percentage", "court_name", "court_ori", "district", "region",
    "court_type",
